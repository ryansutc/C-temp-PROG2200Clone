...
namespace ChatLib
{
    public abstract class Messenger
    {
        ...
        public abstract bool Start(String ipAddress, int port, out string errorMessage);
        ...
        {
            //this code copied from here: http://stackoverflow.com/questions/2661764/how-to-check-if-a-socket-is-connected-disconnected-in-c
            try
            { 
